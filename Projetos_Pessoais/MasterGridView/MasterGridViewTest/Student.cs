...
namespace MasterGridViewTest
{
    public class Student
    {
        ...
        public static List<Student> getStudents()
        {
            ...
            list.Add(new Student() { Id = 2, FirstName = "Rick", LastName = "Sanchez", lstQualifications = Qualifications.getNotes(), lstCourses = Course.getCourses() });
            list.Add(new Student() { Id = 3, FirstName = "John", LastName = "Doe", lstQualifications = Qualifications.getNotes2(), lstCourses = Course.getCourses2() });
